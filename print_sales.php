	...
	<table width="100%">
				...
				<tr>
					<th class="text-center">
						<p>
							<b style="padding-bottom: 0px">SMberry</b><br>
							<small style="padding-bottom: 0px">Address: VSU Upper Campus</small><br>
							<small style="padding-top: 0px">Email: @mulberrymenshomedormitory</small>
						</p>
					</th>
				</tr>
				<tr>
